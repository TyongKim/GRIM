...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
gfundata(1).expression = '4-x(:,2).^2-x(:,1).^2';
gfundata(2).expression = ' -x(:,1)';
gfundata(3).expression = ' -x(:,2)';

gfundata(4).expression = '- x(:,1)+2';
gfundata(5).expression = ' x(:,2)';

gfundata(6).expression = '- x(:,2)+2';
gfundata(7).expression = ' x(:,1)';
...
system_data.type    = 'general';      %(series/parallel/general/no)
system_data.general = [1 2 3 0 4 5 0 6 7];
